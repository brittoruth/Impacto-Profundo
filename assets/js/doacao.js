    ...
    console.log(valor);
      if(valor ==0){
        mostrarCamisa();
        mostrarCanecaAzul();
        mostrarCanecaLaranja();
        mostrarCanecaVerde();
      }
      else if( valor == 1){
        mostrarCamisa();
        esconderCanecaAzul();
        esconderCanecaLaranja();
        esconderCanecaVerde();
  ...
  function esconderCanecaLaranja(){
